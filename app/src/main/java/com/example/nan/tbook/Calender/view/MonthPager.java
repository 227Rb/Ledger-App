...
import com.example.nan.tbook.Calender.behavior.*;
...
public class MonthPager extends ViewPager {
    ...
    public void setViewHeight(int viewHeight) {
        cellHeight = viewHeight / calendarRow;
    ...
    public int getRowIndex() {
        CalendarViewAdapter calendarViewAdapter = (CalendarViewAdapter) getAdapter();
        rowIndex = calendarViewAdapter.getPagers().get(currentPosition % 3).getSelectedRowIndex();
        Log.e("textSc2", "getRowIndex = " + rowIndex);
        return rowIndex;
    }

    public void setCalendarRow(int calendarRow) {
